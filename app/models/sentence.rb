class Sentence < ActiveRecord::Base
  ...
  class << self
    ...
    def parse_and_create(sentence_text, parent_paragraph)
      Sentence.create!(paragraph: parent_paragraph,
                       paragraph_index: parent_paragraph.sentences.count).set_text(sentence_text)
    end
  end
  ...
  #     word_list_to_shift = Array.new(word_list)
  #     apply_template_to_words_or_texts_in(word_list_to_shift) { |pattern_character, word_list_to_shift|
  #       Word.render_text_with_template(word_list_to_shift.shift, pattern_character) }
  #   end
  #
  #   # used for Words
  ...
  #     word_list_to_shift = Array.new(word_list)
  #     apply_template_to_words_or_texts_in(word_list_to_shift ) { |pattern_character, word_list_to_shift |
  #       word_list_to_shift .shift.rendered_with(pattern_character) }
  #   end
  #
